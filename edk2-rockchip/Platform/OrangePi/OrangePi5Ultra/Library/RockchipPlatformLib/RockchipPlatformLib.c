...
VOID
   ...
   )
 {
   switch (Id) {
     case 0:
       GpioPinSetFunction (2, GPIO_PIN_PC4, 4); //HDMITX1_CEC_M0
       GpioPinSetPull (2, GPIO_PIN_PC4, GPIO_PIN_PULL_NONE);
       GpioPinSetFunction (1, GPIO_PIN_PA6, 5); //HDMITX1_HDPIN_M0
       GpioPinSetPull (1, GPIO_PIN_PA6, GPIO_PIN_PULL_NONE);
       GpioPinSetFunction (3, GPIO_PIN_PC6, 5); //HDMITX1_SCL_M1
       GpioPinSetPull (3, GPIO_PIN_PC6, GPIO_PIN_PULL_NONE);
       GpioPinSetFunction (3, GPIO_PIN_PC5, 5); //HDMITX1_SDA_M1
